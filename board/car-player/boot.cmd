...
setenv bootargs "console=ttyAML0,115200n8 root=/dev/nfs ip=dhcp nfsroot=${serverip}:/,tcp,nfsvers=4 earlyprintk rw rootwait usbcore.autosuspend=-1 fbcon=map:2"
