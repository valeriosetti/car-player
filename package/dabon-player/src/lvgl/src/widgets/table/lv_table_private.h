...
struct lv_table_t {
    ...
    uint32_t col_act;
    uint32_t row_act;
    uint32_t col_sel; /**< The same as col_act, but the value is kept even after release event */
    uint32_t row_sel; /**< The same as row_act, but the value is kept even after release event */
};
